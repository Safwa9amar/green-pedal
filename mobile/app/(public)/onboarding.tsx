...
export default function Onboarding() {
  // Theme colors from enhanced app theme
    ...
    () => [
      {
        ...
        title: "Locate a Bike",
        description:
          "Find nearby bikes on the map and pick the closest one to you.",
      ...
      },
      {
        ...
        description:
          "Scan the QR code to unlock the bike and get ready to ride.",
      ...
      },
      {
        ...
        title: "Ride & Enjoy",
        description:
          "Cruise to your destination and return the bike at any station.",
      ...
      >
            ...
            <View
              ...
              style={[
                ...
                i === index
                  ...
                  : [styles.dotInactive, { backgroundColor: border }],
              ]}
            />
          ))}
        </View>
        ...
        <View style={styles.footerWrap}>
          <TouchableOpacity onPress={handleSkip}>
            <Text style={[styles.footerText, { color: primary }]}>Skip</Text>
          </TouchableOpacity>
            ...
            {steps.map((_, i) => (
              <View
                ...
                style={[
                  styles.dot,
                  i === index
                    ? [styles.dotActive, { backgroundColor: primary }]
                    : [styles.dotInactive, { backgroundColor: border }],
                ]}
              />
            ))}
          ...
          <TouchableOpacity onPress={handleNext}>
            <Text style={[styles.footerText, { color: primary }]}>
              {isLast ? "Next" : "Next"}
            </Text>
          </TouchableOpacity>
        </View>
